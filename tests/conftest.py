...
def sample_project(temp_dir):
    ...
    return {"root": project_root, "files": created_files}
...
def run_script(script_path, args, cwd=None):
    ...
    # Set environment with UTF-8 encoding for proper emoji handling
    env = os.environ.copy()
...
def bootstrap_script(workspace_root):
    ...
    """
    return workspace_root / "tools" / "seda_bootstrap.py"
...
def packer_script(workspace_root):
    ...
    """
    return workspace_root / "tools" / "seda_packer.py"
